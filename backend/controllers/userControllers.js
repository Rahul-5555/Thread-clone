...
const loginUser = async (req, res) => {
  try {
    ...
    res.status(200).json({
      ...
      bio: user.bio, // Fixed: Changed from newUser.bio to user.bio
      profilePic: user.profilePic, // Fixed: Changed from newUser.profilePic to user.profilePic
    });
  } catch (error) {
    // Handle errors
...
const followUnfollowUser = async (req, res) => {
  try {
    ...
    // Check if current user is already following userToModify
